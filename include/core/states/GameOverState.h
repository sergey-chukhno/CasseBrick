...
private:
    ...
    static constexpr float STATISTICS_COLOR_CHANGE_SPEED = 1.0f; // Statistics color change speed (slightly slower)
    ...
    static constexpr float PLANET_MIN_ROTATION_SPEED = 10.0f; // Degrees per second
    ...
    static constexpr float PLANET_GLOW_MULTIPLIER = 2.5f;   // Glow radius for pulsar planets
    static constexpr float PLANET_PULSE_SPEED = 1.5f;       // Pulse speed for pulsar planets
    static constexpr float PULSAR_MIN_RADIUS = 3.0f;
    static constexpr float PULSAR_MAX_RADIUS = 6.0f;
    static constexpr float PULSAR_GLOW_MULTIPLIER = 3.0f;  // Glow radius multiplier
